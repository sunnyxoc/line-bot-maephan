...
export const COMPLAINT_KEYWORDS = [
  'เสีย', 'บูด', 'ขึ้นรา', 'หมดอายุ', 'ของไม่ครบ', 'ไม่ครบ', 'ผิดออเดอร์', 'ส่งผิด',
  'แตก', 'รั่ว', 'ซึม', 'คืนเงิน', 'เคลม', 'ร้องเรียน', 'ไม่ได้รับของ', 'ของยังไม่ถึง',
  'แพ้', 'ท้องเสีย', 'ปวดท้อง', 'อาหารเป็นพิษ',
  'บุบ', 'ยุบ', 'บิ่น', 'ฝาหลวม', 'ฝาเปิดไม่ออก', 'ซีลขาด', 'ซีลหลุด',
  'ฉลากหลุด', 'กล่องพัง', 'พัง', 'ชำรุด', 'เสียหาย', 'ไม่ได้คุณภาพ',
  'มีปัญหา', 'ผิดปกติ', 'กลิ่นแปลก', 'รสแปลก', 'สีแปลก', 'มีสิ่งแปลกปลอม',
  'ไม่พอใจ', 'แย่', 'ห่วย', 'โกง', 'หลอก', 'ได้ไม่ครบ', 'ขาดไป', 'หาย',
  'แพ็คมาไม่ดี', 'แพ็คไม่ดี', 'ห่อไม่ดี', 'สิ่งแปลกปลอม',
];
